...
# n-gram model with a dictionary of 2-grams
word_dict = {}
...
for i in range(len(training_data)):
    # initialize a vector of size (1*11166) 
...
# testing vector of size (600*11166) 
testing_vectors = []
...
# print 10 most significant 2-gram words
important_words = []
for i in range(10):
